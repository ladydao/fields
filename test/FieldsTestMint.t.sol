...
contract MintTest is Test {
    ...
    function testMintRevertMintWithoutValue() public {
        ...
        fields.safeMint("bafkreidcapki3wfwy356um7wvwiud4cpnrucnuumtlw6g3fjx6eswynlx4");
    }
    ...
    function testMintRevertMintWithWrongValue() public {
        ...
        vm.expectRevert(Fields.MintPriceNotPaid.selector);
        fields.safeMint{value: 0.15 ether}("bafkreidcapki3wfwy356um7wvwiud4cpnrucnuumtlw6g3fjx6eswynlx4");
    }
    ...
    function testMintIdIncreasesOnMinting() public {
        vm.prank(address(1));
        vm.deal(address(1), 1 ether);
        uint256 id1 = fields.safeMint{value: 0.1 ether}("bafkreidcapki3wfwy356um7wvwiud4cpnrucnuumtlw6g3fjx6eswynlx4");

        vm.prank(address(1));
        uint256 id2 = fields.safeMint{value: 0.1 ether}("bafkreidl6rlm5rqgn3b5b7b5tg4hfas7ansnk3e36agcncwijd5tupqwp4");
        assertGt(id2, id1);
    }
    ...
    function testMintBalanceIncremented() public {
        ...
        fields.safeMint{value: 0.1 ether}("bafkreidl6rlm5rqgn3b5b7b5tg4hfas7ansnk3e36agcncwijd5tupqwp4");
